  ...
  public class TransactionService : ITransactionService
  {
    ...
    public async Task<FunctionResponse> StartTransaction(StartTransactionRequest transactionRequest)
    {
      ...
      try
      {
        ...
        _client.DefaultRequestHeaders.AddOrReplace(Constants.Headers.IsBatchedTransaction, transactionRequest.IsBatchedTransaction);
        _client.DefaultRequestHeaders.AddOrReplace(Constants.Headers.BatchId, transactionRequest.BatchId);
        _client.DefaultRequestHeaders.AddOrReplace(Constants.Headers.IsBatchedStage, transactionRequest.IsBatchedStage);
    ...
    public async Task<FunctionResponse> CheckPoint(CheckPointRequest checkPointRequest)
    {
      ...
      try
      {
        ...
        _client.DefaultRequestHeaders.AddOrReplace(Constants.Headers.IsBatchedStage, checkPointRequest.IsBatchedStage);
